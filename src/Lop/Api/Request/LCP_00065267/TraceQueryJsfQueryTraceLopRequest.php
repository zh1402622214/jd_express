...
* 
*/
class TraceQueryJsfQueryTraceLopRequest extends DomainAbstractRequest{
    private $domainHttpParam;
   /**
    * Created with IntelliJ IDEA. <p/> User: yangrunjie Date: 2016/9/18 Time: ${Time}
    */
    private $queryDTO;
...
public function getApiMethod(){
    return "/TraceQueryJsf/queryTrace";
}
